...
Supported usage:
    python3 src/m20_fastlio_nav/scripts/level_pcd.py /path/to/in.pcd /path/to/out.pcd
    python3 src/m20_fastlio_nav/scripts/level_pcd.py --input /path/to/in.pcd --output /path/to/out.pcd
