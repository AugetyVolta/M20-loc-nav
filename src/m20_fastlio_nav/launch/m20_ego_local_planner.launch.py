...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("ground_height", default_value="-2.0"),
            DeclareLaunchArgument("ego_goal_topic", default_value="/ego_goal_pose"),
            DeclareLaunchArgument("min_goal_z", default_value="-100.0"),
            DeclareLaunchArgument("goal_change_threshold", default_value="0.15"),
            DeclareLaunchArgument("goal_reached_threshold", default_value="0.20"),
            ...
            DeclareLaunchArgument("cloud_self_filter_radius", default_value="0.80"),
            DeclareLaunchArgument("cloud_self_filter_z_min", default_value="-1.20"),
            DeclareLaunchArgument("cloud_self_filter_z_max", default_value="1.60"),
            DeclareLaunchArgument("map_size_x", default_value="30.0"),
            DeclareLaunchArgument("map_size_y", default_value="20.0"),
            DeclareLaunchArgument("map_size_z", default_value="24.0"),
            ...
            DeclareLaunchArgument("path_timeout", default_value="2.0"),
            ego_odom_bridge,
            ego_cloud_bridge,
