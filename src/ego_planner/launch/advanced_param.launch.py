...
def generate_launch_description():
    ...
    grid_map_frame = LaunchConfiguration('grid_map_frame', default='body')
    grid_map_pose_type = LaunchConfiguration('grid_map_pose_type', default=1)
    ...
    grid_map_frame_arg = DeclareLaunchArgument('grid_map_frame', default_value=grid_map_frame, description='Grid map frame id')
    grid_map_pose_type_arg = DeclareLaunchArgument('grid_map_pose_type', default_value=grid_map_pose_type, description='Grid map pose input type: 1=PoseStamped, 2=Odometry')
    ...
    ego_planner_node = Node(
        ...
        parameters=[
            ...
            {'grid_map/pose_type': grid_map_pose_type},
            {'grid_map/frame_id': grid_map_frame},
            # planner manager
            ...
            {'optimization/xy_extend': xy_extend},
            {'optimization/z_extend': z_extend},
    ...
    ld.add_action(grid_map_frame_arg)
    ld.add_action(grid_map_pose_type_arg)
