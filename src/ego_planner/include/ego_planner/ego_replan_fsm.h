...
namespace ego_planner
{
  ...
  private:
    ...
    rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr waypoint_ego_goal_sub_;
    rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr waypoint_move_base_sub_;
