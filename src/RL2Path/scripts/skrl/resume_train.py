...
parser.add_argument("--sb3_checkpoint", type=str, default=None,
                    help="Path to SB3 model.zip for warm-starting skrl")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: dict):
    ...
    imtation_config = tomli.load(open(args_cli.imitation_cfg, 'rb'))['imitation']
    goal_include_theta = imtation_config.get('goal_include_theta', True)
    ...
    memory = RandomMemory(memory_size=agent_cfg["agent"]["rollouts"])
